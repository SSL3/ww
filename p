...
wget -O /etc/nginx/nginx.conf "http://borneovpshosting.com/autoscript/debian8/nginx.conf"
wget -O /etc/nginx/conf.d/vps.conf "http://borneovpshosting.com/autoscript/debian8/vps.conf"
...
wget http://vpsproject.me/Debian7/OrangKuatSabah.zip
...
echo "Login at http://$MYIP:81" | tee -a log-install.txt | lolcat
echo "" | tee -a log-install.txt | lolcat
echo "OCS Panel V2 | By VpsProject"  | tee -a log-install.txt
echo "" | tee -a log-install.txt | lolcat
echo "Thanks " | tee -a log-install.txt | lolcat
echo "" | tee -a log-install.txt | lolcat
echo "Log Instalasi --> /root/log-install.txt" | tee -a log-install.txt | lolcat
echo "=======================================================" | tee -a log-install.txt | lolcat
cd ~/
